...
const investmentSlides = [
  { sector: "Tourism", title: "EXPLORE: TOURISM INVESTMENT OPPORTUNITIES IN BOTSWANA", description: "Discover premium eco-tourism, hospitality and conservation-led opportunities across Botswana’s remarkable destinations.", image: "/thabo-opportunities/tourism-01.jpeg", script: "Explore tourism investment opportunities in Botswana, where conservation, culture and premium hospitality create lasting value." },
  { sector: "Mining", title: "EXPLORE: MINING INVESTMENT OPPORTUNITIES IN BOTSWANA", description: "Explore responsible mineral development, value addition, infrastructure and partnership opportunities in a stable market.", image: "/thabo-opportunities/mining-01.jpeg", script: "Explore mining investment opportunities in Botswana, supported by a stable business environment and strong partnership potential." },
  { sector: "Agriculture", title: "EXPLORE: AGRICULTURE INVESTMENT OPPORTUNITIES IN BOTSWANA", description: "Invest across production, livestock, agri-processing, food security and sustainable regional value chains.", image: "/thabo-opportunities/agriculture-01.jpeg", script: "Explore agriculture investment opportunities in Botswana, from livestock and production to agri-processing and sustainable value chains." },
  { sector: "Tourism", title: "EXPLORE: TOURISM INVESTMENT OPPORTUNITIES IN BOTSWANA", description: "Connect with world-class wilderness experiences and the services, lodges and transport networks that support them.", image: "/thabo-opportunities/tourism-02.jpeg", script: "Discover Botswana tourism opportunities built around world-class wilderness, hospitality and unforgettable visitor experiences." },
  { sector: "Mining", title: "EXPLORE: MINING INVESTMENT OPPORTUNITIES IN BOTSWANA", description: "Find opportunities spanning exploration, technology, services, beneficiation and responsible mine operations.", image: "/thabo-opportunities/mining-02.jpeg", script: "Discover opportunities across Botswana mining, including exploration, services, technology and local value addition." },
  { sector: "Agriculture", title: "EXPLORE: AGRICULTURE INVESTMENT OPPORTUNITIES IN BOTSWANA", description: "Grow with Botswana through horticulture, modern farming, logistics, processing and export-ready agribusiness.", image: "/thabo-opportunities/agriculture-02.jpeg", script: "Grow with Botswana through modern agriculture, horticulture, logistics, processing and export-ready agribusiness." },
] as const;
